...
class VQ_VAE(nn.Module):
    ...
    def __init__(self, emb_size=784, enc_hidden_size=400, dec_hidden_size=400, latent_size=200, k=10, vq_coef=0.2, comit_coef=0.4, **kwargs):
    ...
    def sample(self, size):
        ...
        sample = self.decode(emb(sample).view(-1, self.latent_size)).cpu()
        return sample
